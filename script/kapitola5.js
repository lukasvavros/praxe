...
const cells=Array.from({length:32},()=>{const el=document.createElement('span');el.className='lcd-cell';el.setAttribute('aria-hidden','true');screen.append(el);return el;});
