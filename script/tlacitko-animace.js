(() => {
  ...
  if (!root) return;
  // Uložen je pouze SHA-256 otisk hesla. Jde o výukové skrytí řešení.
  const SOLUTION_PASSWORD_HASH = '87d113d7ca8d1b6d6687039b5896b3fa4289f0b84bae5091a5fc921f15655bfb';
  ...
  form.addEventListener('submit', async event => {
    ...
    try {
      ...
      error.textContent = 'Heslo nelze ověřit. Otevři stránku přes HTTPS v aktuálním prohlížeči.';
      return;
    }
